                                ...
                                <div class="max-w-[680px] mx-auto text-center xl:text-left">
                                  ...
                                  after:bg-no-repeat mb-7">
                                        <span class="mx-2">
                                            ...
                                            quaerat
                                            repellat, ipsam, laborum sit odio reiciendis dicta eum cum magni
                                            reprehenderit
                                            incidunt possimus sint maxime dolorum nulla modi consequatur!
                                        </span>
                                    </p>
                                    <!-- name -->
                                    <div class="text-[26px] text-[#4c5354] font-semibold">James Rodrigo</div>
                                    <!-- job -->
                                    <div class="text-[#9ab4b7] font-medium uppercase
                                  tracking-[2.24px]">Customer</div>
                                </div>
                            </div>
                        </div>
                        <!-- slide 2 -->
                            ...
                            <div class="h-full flex flex-col justify-center items-start">
                                <div class="max-w-[680px] mx-auto text-center xl:text-left">
                                    ...
                                    <p class="font-light relative text-[22px] text-[#4c5354]
                                                       ...
                                                       after:bg-no-repeat mb-7">
                                        <span class="mx-2">
                                            Lorem ipsum, adipisicing elit. Labore vitae quaerat
                                            repellat, ipsam, laborum sit odio reiciendis dicta eum cum magni
                                            reprehenderit
                                            incidunt nulla modi consequatur!
                                        </span>
                                    </p>
                                    <!-- name -->
                                    <div class="text-[26px] text-[#4c5354] font-semibold">Julia</div>
                                    <!-- job -->
                                    <div class="text-[#9ab4b7] font-medium uppercase
                                                       tracking-[2.24px]">Home</div>
                                </div>
                            </div>
                        </div>
                        <!-- slide 3 -->
                                ...
                                <div class="max-w-[680px] mx-auto text-center xl:text-left">
                                    ...
                                    <p class="font-light relative text-[22px] text-[#4c5354]
                                        ...
                                        <span class="mx-2">
                                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Labore vitae
                                            quaerat
                                            repellat, ipsam, laborum sit!
                                        </span>
                                    </p>
                                    <!-- name -->
                                    <div class="text-[26px] text-[#4c5354] font-semibold">Art Tema</div>
                                    <!-- job -->
                                    <div class="text-[#9ab4b7] font-medium uppercase
                                                       tracking-[2.24px]">User</div>
                                </div>
                            </div>
                        </div>
                    </div>
